...
function zc_trips_date_shortcode() {
    wp_enqueue_style('zc-crud-style', plugins_url('assets/css/trip-dates-pagez10.css', __FILE__));
    ob_start();
...
function zc_trip_details_shortcode() {
    wp_enqueue_style('zc-crud-style', plugins_url('assets/css/trip-details-page20.css', __FILE__));
    ob_start();
